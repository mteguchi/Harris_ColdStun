...
Quick regression
```{r}
# need to use species as covariate? but there are only three Cc strandings... not useful? 
fit.1 <- glm(n ~ max.MEI + max.ONI + max.PDO + max.MEI.lag6mo + max.ONI.lag6mo + max.PDO.lag6mo, 
             family = poisson, data = dat1.oce.sp)

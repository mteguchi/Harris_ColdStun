...
```{r}
ggplot(data = dat1) + 
  geom_point(aes(x = Date, y = SST_3, color = Species))
```

```{r}
ggplot(data = dat1) + 
  geom_point(aes(x = Date, y = SST_3_ANOM, color = Species))
...
```{r}
ggplot(data = dat1) + 
  geom_point(aes(x = Date, y = SST_3_CV, color = Species))
...
```{r}
ggplot(data = dat1) + 
  geom_point(aes(x = Date, y = SST_3_lag30, color = Species))
...
```{r}
ggplot(data = dat1) + 
  geom_point(aes(x = Date, y = SST_3_ANOM_lag30, color = Species))

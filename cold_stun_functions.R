...
get_ocedata_fcn <- function(ds, dat0, dataset = "coldstun"){
  ...
  wind_max <- data.frame(wind_max)
  wind_30d <- data.frame(wind_30d)
  wind_max_30d <- data.frame(wind_max_30d)
  
  out.list <- list(sst0125 = sst0125, sst0125_sd = sst0125_sd, sst0125_min = sst0125_min,
                   sst0125_lag30d = sst0125_lag30d, sst0125_sd_lag30d = sst0125_sd_lag30d, 
                   sst0125_min_lag30d = sst0125_min_lag30d,
                   sst = sst, sst_sd = sst_sd, sst_min = sst_min, 
                   sst_anom = sst_anom, sst_lag30d = sst_lag30d,
                   sst_min_lag30d = sst_min_lag30d, sst_anom_30d = sst_anom_30d, wind = wind, 
                   wind_max = wind_max, wind_30d = wind_30d, wind_max_30d = wind_max_30d)
  return(out.list)
}

...
for (k in 1:length(sst)){
  ...
  for (k1 in 1:d.n){
      xlim <- c(latlon[k, (2*k1 + 1)],
                latlon[k, (2*k1 + 3)])
      ylim <- c(latlon[k, (2*k1 + 2)],
                latlon[k, (2*k1 + 4)])
      ...
      # 2018-11-02
      sstURL <- paste0("https://coastwatch.pfeg.noaa.gov/erddap/griddap/jplMURSST41.htmlTable?analysed_sst%5B(", latlon[k, "Date"], 
...
```
https://coastwatch.pfeg.noaa.gov/erddap/griddap/jplMURSST41.htmlTable?analysed_sst%5B(2002-06-01T09:00:00Z)%5D%5B(-89.99):1000:(89.99)%5D%5B(-179.99):1000:(180.0)%5D

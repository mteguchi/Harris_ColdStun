# for downloading SST etc files from CoastWatch for all strandings
...
all.strandings %>% rownames_to_column() %>%
  ...
  select(ID, Species, Date, State, Latitude, Longitude, CCL_cm, Weight_kg) -> dat0
...
for (k in 1:nrow(latlon)){
  ...
  # resolutions
  out.file.name.wind <- paste0("data/ncfiles/turtle_all_", dat0[k, "ID"], "_",
                               "wind.nc")
  
  out.file.name.wind.30d <- paste0("data/ncfiles/turtle_all_", dat0[k, "ID"], "_",
                                   "wind_30d.nc")
  
  # for number of distances
  for (k1 in 1:d.n){
    out.file.name <- paste0("data/ncfiles/turtle_all_", dat0[k, "ID"], "_",
                            ds[k1], "km_sst.nc")
    out.file.name.anom <- paste0("data/ncfiles/turtle_all_", dat0[k, "ID"], "_",
                                 ds[k1], "km_sstanom.nc")
    out.file.name.lag30d<- paste0("data/ncfiles/turtle_all_", dat0[k, "ID"], "_",
                                  ds[k1], "km_sst_lag30d.nc")
    out.file.name.anom.lag30d <- paste0("data/ncfiles/turtle_all_", dat0[k, "ID"], "_",
                                        ds[k1], "km_sstanom_lag30d.nc")
    out.file.name.air.temp<- paste0("data/ncfiles/turtle_all_", dat0[k, "ID"], "_",
                                    ds[k1], "km_airtemp.nc")
    out.file.name.air.temp.lag30d <- paste0("data/ncfiles/turtle_all_", dat0[k, "ID"], "_",
                                            ds[k1], "km_airtemp_lag30d.nc")
    out.file.name.sst.0125 <- paste0("data/ncfiles/turtle_all_", dat0[k, "ID"], "_",
                                     ds[k1], "km_sst0125.nc")
    out.file.name.sst.0125.lag30d <- paste0("data/ncfiles/turtle_all_", dat0[k, "ID"], "_",
